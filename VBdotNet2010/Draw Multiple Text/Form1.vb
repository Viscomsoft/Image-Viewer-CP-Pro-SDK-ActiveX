...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Command5.Text = "Save text for all pages"
        ...
        Me.btnsaveonly.Text = "Save text for page 2 only"
        '
        'Form1
        '
...
#End Region 
    Sub DrawShapes()
        ...
        AxImageViewer1.SetOutlineTextBorderColor(RGB(0, 0, 0))
        AxImageViewer1.TextFontSize = 30
        AxImageViewer1.TextFontName = "Arial"
        ...
        AxImageViewer1.SetOutlineTextBorderColor(RGB(0, 0, 255))
        AxImageViewer1.SetOutlineTextBackColor(RGB(255, 0, 0))
